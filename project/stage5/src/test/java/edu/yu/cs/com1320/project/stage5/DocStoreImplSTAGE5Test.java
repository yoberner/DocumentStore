...
public class DocStoreImplSTAGE5Test {
    ...
    @Test
    public void stage4Test() {
        store4.putDocument(input1, uri1, DocumentFormat.TXT);
        store4.putDocument(input2, uri2, DocumentFormat.TXT);
        store4.putDocument(input3, uri3, DocumentFormat.TXT);
        
        store4.getDocumentAsTxt(uri1);
        store4.search("1");
        store4.getDocumentAsTxt(uri3);
        store4.search("3");
        store4.setMaxDocumentCount(2);

        List<String> list = new ArrayList<String>();
        list.add(string1);
        list.add(string3);
        //assertEquals(list, store4.search("test"));

        store4.setMaxDocumentCount(5);
        store4.putDocument(input4, uri4, DocumentFormat.TXT);
        store4.putDocument(input5, uri5, DocumentFormat.TXT);
        store4.putDocument(input6, uri6, DocumentFormat.TXT);
        ...
        list2.add(string5);
        list2.add(string6);
        //assertEquals(list2, store4.searchByPrefix("t"));
        store4.getDocumentAsPdf(uri3);
        store4.getDocumentAsTxt(uri4);
        store4.getDocumentAsPdf(uri5);
        store4.getDocumentAsTxt(uri6);
        store4.setMaxDocumentCount(4);
