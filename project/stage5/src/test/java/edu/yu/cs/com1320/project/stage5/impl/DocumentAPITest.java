...
public class DocumentAPITest {
    ...
    //STAGE 5 TESTS
    @Test
    public void stage5GetWordMapExists()throws URISyntaxException {
        URI uri = new URI("https://this.com");
        try {
            new DocumentImpl(uri, "hi", 1).getWordMap();
        } catch (RuntimeException e) {}
    }
    @Test
    public void stage5SetWordMapExists()throws URISyntaxException {
        URI uri = new URI("https://this.com");
        try {
            new DocumentImpl(uri, "hi", 1).setWordMap(new HashMap<String,Integer>());
        } catch (RuntimeException e) {}
    }
}